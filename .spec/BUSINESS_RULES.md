# BUSINESS_RULES.md: Nureaknite

## Core Business Rules

These rules define the fundamental operational policies and constraints governing the Nureaknite platform.

*   **BR-01: Single Creator Principle:** All content (patterns, blog posts, portfolio items) and products offered on Nureaknite originate solely from the designated creator (Admin). The platform does not support multiple vendors, instructors, or community contributions.
...
*   **Patterns:**
    *   Each pattern must have a unique identifier.
    *   Must be associated with a craft type (e.g., Knitting, Crochet).
    *   Must have a difficulty level (e.g., Beginner, Intermediate, Advanced).
...
*   **Content Uploads:**
    ...
    *   Images for products, portfolio, and blog must be in common web image formats (e.g., JPG, PNG, WebP).
...
*   **Admin (Creator):**
    *   Has full administrative access to the Headless CMS (Strapi).
    *   Can perform CRUD operations on all content types: Patterns, Blog Posts, Portfolio Items, and Shop Products.
