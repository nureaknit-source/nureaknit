# FEATURES.md: Nureaknite

## 1. Authentication & User Management

This module provides the core functionality for users to create and manage their accounts, enabling access to pattern downloads and wishlist features.
...
*   **Acceptance Criteria:**
    ...
    *   A "Forgot Password" flow is available, allowing users to reset their password via email.
...
*   **Edge Cases:**
    ...
    *   Large number of patterns impacting loading performance (pagination/lazy loading considered for future).
...
*   **Acceptance Criteria:**
    ...
    *   Content is managed via the headless CMS (Strapi).
*   **Edge Cases:**
...
## 8. Admin Content Management (via Strapi)

The creator manages all website content through a headless CMS (Strapi). This section outlines the capabilities provided by the CMS for the Admin (Creator).
...
*   **User Stories:**
    *   As an Admin, I want to manage all website content (patterns, blog posts, portfolio items, shop products) from a single interface.
*   **Acceptance Criteria:**
    *   The Strapi CMS provides dedicated content types for Patterns, Blog Posts, Portfolio Items, and Shop Products.
    *   Admin can perform full CRUD operations on all these content types.
*   **Edge Cases:**
...
*   **Acceptance Criteria:**
    ...
    *   Admin can select craft type (knitting/crochet) and difficulty level (Beginner, Intermediate, Advanced) from predefined options.
*   **Edge Cases:**
...
*   **Acceptance Criteria:**
    *   A dedicated section in Strapi displays all coaching requests.
